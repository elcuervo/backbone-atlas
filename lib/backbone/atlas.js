      ...
      Model.prototype.set = function() {
        ...
        for (key in attrs) {
          ...
          if (key in this.relations.has) {
            switch (true) {
              case attributes instanceof Backbone.Atlas.Model:
                this.attributes[key] = attributes;
                break;
              case (this.get(key) != null) && (this.get(key).update_attributes != null):
            ...
            if this.get(key)?
              ...
              if attributes instanceof Backbone.Atlas.Model
                this.attributes[key] = attributes
              else
                this.attributes[key] = new this.relations.has[key](attributes)
            delete attrs[key]
